...
LoadingScreen::render(GfxMgrRef gfxMgr, double percentDone)
{
  ...
  Color4 outlineCol  = MinVR::ConfigVal("LoadingScreenOutlineCol",    Color4(1.0,1.0,1.0,1.0),false);
  Color4 bgCol       = MinVR::ConfigVal("LoadingScreenBackgroundCol", Color4(0.1,0.1,0.44,1.0),false);
  Color4 barCol      = MinVR::ConfigVal("LoadingScreenBarCol",        Color4(0.61,0.72,0.92,1.0),false);
  Color4 titleCol    = MinVR::ConfigVal("LoadingScreenTitleCol",      Color4(1.0,1.0,1.0,1.0),false);//Color4(0.61,0.72,0.92,1.0),false);
  Color4 percCol     = MinVR::ConfigVal("LoadingScreenPercCol",       Color4(0.8,0.22,0.0,1.0),false);
  ...
  // percentage
  font->draw2D(rd, MinVR::intToString(perc) + " %", barCtr, 12, percCol, Color4::clear(),
